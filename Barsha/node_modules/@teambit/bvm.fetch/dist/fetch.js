...
function fetch(version, opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const destinationDir = path_1.default.dirname(destination);
        ...
        yield toolbox_network_progress_bar_file_downloader_1.download(url, destination, {}, progressBarOpts, config.proxyConfig());
        const downloadEndTime = Date.now();
        const downloadTimeDiff = time_time_format_1.timeFormat(downloadEndTime - downloadStartTime);
