...
<td className="whitespace-nowrap px-3 py-3">Tamil Nadu</td>
<td className="whitespace-nowrap px-3 py-3">Chennai</td>
<td className="whitespace-nowrap px-3 py-3">600021</td>
